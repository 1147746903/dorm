              ...
              <div class="card-body">
                <form action="add" id="repairs-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input readonly=“readonly” type="text" class="form-control required" id="name" name="student.studentName" value="${user.username!""}" placeholder="请输入学生姓名" tips="请填写学生姓名" />
                  </div>
                    <div class="input-group m-b-10">
                    ...
                    <div class="input-group m-b-10">
                        ...
                        <input type="text" class="form-control required"  readonly=“readonly” id="name" name="student.mobile" value="${user.mobile!""}" placeholder="请输入联系方式" tips="请填写联系方式" />
                    </div>
                    <div class="input-group m-b-10">
