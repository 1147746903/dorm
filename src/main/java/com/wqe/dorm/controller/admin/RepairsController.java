package com.wqe.dorm.controller.admin;

import com.wqe.dorm.bean.CodeMsg;
import com.wqe.dorm.bean.PageBean;
import com.wqe.dorm.bean.Result;
import com.wqe.dorm.entity.admin.*;
import com.wqe.dorm.service.admin.*;
import com.wqe.dorm.util.SessionUtil;
import com.wqe.dorm.util.ValidateEntityUtil;
...
//            System.out.println(repairs.getEmp());
//            System.out.println(repairs.toString());
            System.out.println(repairs.getDormitory().getId());
            Dormitory dormitory=dormitoryService.find(repairs.getDormitory().getId());
            mailService.send(emailEmp.getEmail(), "任务发配"+dormitory.getRoomNo()+"宿舍", Objects.nonNull(repairs.getRemark()) ? repairs.getRemark() : "任务接收人修改为您，请快完成");
        }
        return Result.success(true);
    }
