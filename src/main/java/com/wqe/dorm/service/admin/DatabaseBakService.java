...
import com.wqe.dorm.dao.admin.DatabaseBakDao;
...
public class DatabaseBakService {
	...
	@Value("${wqe.database.backup.dir}")
	private String backUpDir;
	@Value("${wqe.database.backup.username}")
	private String dbUsername;
	@Value("${wqe.database.backup.password}")
	private String dbPwd;
	@Value("${wqe.database.backup.database.name}")
