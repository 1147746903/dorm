...
import com.wqe.dorm.entity.admin.Emp;
import com.wqe.dorm.entity.admin.EmpType;
import com.wqe.dorm.entity.admin.Repairs;
...
public interface RepairsDao extends JpaRepository<Repairs, Long> {
    ...
    @Query(value = "select suoyou.all_id\n" +
            ...
            "FROM emp c , (SELECT b.building_id,a.emp_type FROM `repairs` a , dormitory b WHERE a.dormitory_id=b.id and a.id= :id) d \n" +
            ...
            "FROM repairs f, \n" +
            "(SELECT c.id FROM emp c , (SELECT b.building_id,a.emp_type FROM `repairs` a , dormitory b WHERE a.dormitory_id=b.id and a.id= :id) d \n" +
    ...
    @Query(value = "SELECT z.emp_id \n" +
            ...
            "FROM repairs f, \n" +
            "(SELECT c.id FROM emp c , (SELECT b.building_id,a.emp_type FROM `repairs` a , dormitory b WHERE a.dormitory_id=b.id and a.id=?) d \n" +
            "WHERE c.building_bno=d.building_id  and d.emp_type=c.emp_type) g\n" +
